...
abstract class AppLocalizations {
  ...
  /// No description provided for @hadithPlaceholder.
  ///
  /// In en, this message translates to:
  /// **'A selected Hadith will appear here soon.'**
  String get hadithPlaceholder;

  /// No description provided for @categoriesPlaceholder.
  ///
  /// In en, this message translates to:
  /// **'Hadith categories are coming soon.'**
  String get categoriesPlaceholder;

  /// No description provided for @categoryFaith.
  ///
  /// In en, this message translates to:
  /// **'Faith'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Hadiths you save will appear here.'**
